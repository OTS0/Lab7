...
public class Command extends Object {
    ...
    public static HumanBeing createHuman(Scanner in, Account account, boolean fromConsole) {
        HumanBeing human = new HumanBeing();
        try {
            human.setLogin(account.getLogin());
     ...
     */
    public static Integer parseId(String str) throws NullException, NumberFormatException {
        Integer id = null;
        str=str.trim();
        if (equals(str, "")) {
            throw new NullException("command and id");
    ...
    /**
     * Find path and process user input
     * @param path
     * @param forRead
     * @return
     */
    public static String findGoodFile(String path, boolean forRead) {
        ...
        while (!good) {
            ...
            if (!good) {
                System.out.println("Please write a new file path.");
     ...
     */
    public static Answer updateId(ObjectInputStream in, ObjectOutputStream out, Scanner console, Account account,  Integer id) throws IOException, ClassNotFoundException {
        System.out.println("\n\n UPDATE ID");
        HumanBeing human = Command.createHuman(console, account, true);
        human.setId(id);
     ...
     * @throws ClassNotFoundException
     */
    public static Answer removeById(ObjectInputStream in, ObjectOutputStream out, Account account,  Integer id) throws IOException, ClassNotFoundException {
        Request requestNew = new Request();
        requestNew.setId(id);
        requestNew.setAccount(account);
        requestNew.setCommand("id remove");
        out.writeObject(requestNew);
        Answer answerNew = (Answer)in.readObject();
        return answerNew;
    }
